...
- category는 TECH, JOB_SKILL, EXPERIENCE, RISK, CULTURE_FIT, MOTIVATION, COMMUNICATION, OTHER 중 하나만 사용합니다.
- risk_tags와 competency_tags는 각각 최대 4개만 반환합니다.
- 같은 근거를 여러 필드에 반복하지 않습니다.
- 사적 정보나 차별 가능 정보는 질문 소재로 사용하지 않습니다.
- 재생성 시 기존 recommended_revision과 quality_flags의 지적을 반드시 해결하고 같은 지적 사유를 반복하지 않습니다.
"""
